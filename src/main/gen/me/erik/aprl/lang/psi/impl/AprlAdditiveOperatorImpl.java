...
public class AprlAdditiveOperatorImpl extends ASTWrapperPsiElement implements AprlAdditiveOperator {

  public AprlAdditiveOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
