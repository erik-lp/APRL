...
public class AprlAssignmentOperatorImpl extends ASTWrapperPsiElement implements AprlAssignmentOperator {

  public AprlAssignmentOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
