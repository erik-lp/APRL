...
public class AprlBlockImpl extends ASTWrapperPsiElement implements AprlBlock {

  public AprlBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public AprlStatements getStatements() {
    return findNotNullChildByClass(AprlStatements.class);
  }
