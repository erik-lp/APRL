...
public class AprlByOperatorImpl extends ASTWrapperPsiElement implements AprlByOperator {

  public AprlByOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AprlVisitor visitor) {
    visitor.visitByOperator(this);
  }
