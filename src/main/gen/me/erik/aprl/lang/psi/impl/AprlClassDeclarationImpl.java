...
public class AprlClassDeclarationImpl extends ASTWrapperPsiElement implements AprlClassDeclaration {

  public AprlClassDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public AprlDelegationSpecifiers getDelegationSpecifiers() {
    return findChildByClass(AprlDelegationSpecifiers.class);
  }
  ...
  @Override
  @Nullable
  public AprlPrimaryConstructor getPrimaryConstructor() {
    return findChildByClass(AprlPrimaryConstructor.class);
  }
