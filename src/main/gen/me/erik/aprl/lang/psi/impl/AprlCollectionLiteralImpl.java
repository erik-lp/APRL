...
public class AprlCollectionLiteralImpl extends ASTWrapperPsiElement implements AprlCollectionLiteral {

  public AprlCollectionLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
