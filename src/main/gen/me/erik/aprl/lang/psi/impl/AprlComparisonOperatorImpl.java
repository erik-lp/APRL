...
public class AprlComparisonOperatorImpl extends ASTWrapperPsiElement implements AprlComparisonOperator {

  public AprlComparisonOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
