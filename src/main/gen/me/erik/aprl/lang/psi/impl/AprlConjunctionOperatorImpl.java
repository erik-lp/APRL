...
public class AprlConjunctionOperatorImpl extends ASTWrapperPsiElement implements AprlConjunctionOperator {

  public AprlConjunctionOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AprlVisitor visitor) {
    visitor.visitConjunctionOperator(this);
  }
