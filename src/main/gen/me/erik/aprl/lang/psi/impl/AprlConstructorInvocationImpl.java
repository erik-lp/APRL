...
public class AprlConstructorInvocationImpl extends ASTWrapperPsiElement implements AprlConstructorInvocation {

  public AprlConstructorInvocationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public AprlCallSuffix getCallSuffix() {
    return findNotNullChildByClass(AprlCallSuffix.class);
  }

  @Override
  @NotNull
  public AprlUserType getUserType() {
    return findNotNullChildByClass(AprlUserType.class);
  }
