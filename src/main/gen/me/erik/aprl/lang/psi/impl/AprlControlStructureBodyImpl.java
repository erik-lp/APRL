...
public class AprlControlStructureBodyImpl extends ASTWrapperPsiElement implements AprlControlStructureBody {

  public AprlControlStructureBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
