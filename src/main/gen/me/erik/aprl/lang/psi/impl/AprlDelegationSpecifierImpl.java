...
public class AprlDelegationSpecifierImpl extends ASTWrapperPsiElement implements AprlDelegationSpecifier {

  public AprlDelegationSpecifierImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public AprlConstructorInvocation getConstructorInvocation() {
    return findChildByClass(AprlConstructorInvocation.class);
  }
