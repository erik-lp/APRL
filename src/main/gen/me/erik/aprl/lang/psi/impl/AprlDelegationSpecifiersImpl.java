...
public class AprlDelegationSpecifiersImpl extends ASTWrapperPsiElement implements AprlDelegationSpecifiers {

  public AprlDelegationSpecifiersImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<AprlDelegationSpecifier> getDelegationSpecifierList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AprlDelegationSpecifier.class);
  }
