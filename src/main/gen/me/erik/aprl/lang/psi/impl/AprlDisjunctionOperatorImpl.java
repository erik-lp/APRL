...
public class AprlDisjunctionOperatorImpl extends ASTWrapperPsiElement implements AprlDisjunctionOperator {

  public AprlDisjunctionOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AprlVisitor visitor) {
    visitor.visitDisjunctionOperator(this);
  }
