...
public class AprlDoWhileExpressionImpl extends ASTWrapperPsiElement implements AprlDoWhileExpression {

  public AprlDoWhileExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
