...
public class AprlElvisOperatorImpl extends ASTWrapperPsiElement implements AprlElvisOperator {

  public AprlElvisOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AprlVisitor visitor) {
    visitor.visitElvisOperator(this);
  }
