...
public class AprlEnumDeclarationImpl extends ASTWrapperPsiElement implements AprlEnumDeclaration {

  public AprlEnumDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public AprlEnumBody getEnumBody() {
    return findNotNullChildByClass(AprlEnumBody.class);
  }
