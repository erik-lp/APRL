...
public class AprlEqualityOperatorImpl extends ASTWrapperPsiElement implements AprlEqualityOperator {

  public AprlEqualityOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
