...
public class AprlExponentialOperatorImpl extends ASTWrapperPsiElement implements AprlExponentialOperator {

  public AprlExponentialOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AprlVisitor visitor) {
    visitor.visitExponentialOperator(this);
  }
