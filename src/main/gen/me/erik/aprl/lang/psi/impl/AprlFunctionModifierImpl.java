...
public class AprlFunctionModifierImpl extends ASTWrapperPsiElement implements AprlFunctionModifier {

  public AprlFunctionModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
