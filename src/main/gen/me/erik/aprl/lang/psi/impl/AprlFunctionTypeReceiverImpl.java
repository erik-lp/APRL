...
public class AprlFunctionTypeReceiverImpl extends ASTWrapperPsiElement implements AprlFunctionTypeReceiver {

  public AprlFunctionTypeReceiverImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AprlVisitor visitor) {
    visitor.visitFunctionTypeReceiver(this);
  }
