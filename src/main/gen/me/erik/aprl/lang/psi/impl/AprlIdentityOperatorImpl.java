...
public class AprlIdentityOperatorImpl extends ASTWrapperPsiElement implements AprlIdentityOperator {

  public AprlIdentityOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AprlVisitor visitor) {
    visitor.visitIdentityOperator(this);
  }
