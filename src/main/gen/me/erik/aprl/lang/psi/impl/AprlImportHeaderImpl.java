...
public class AprlImportHeaderImpl extends ASTWrapperPsiElement implements AprlImportHeader {

  public AprlImportHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<AprlImportIdentifier> getImportIdentifierList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AprlImportIdentifier.class);
  }
