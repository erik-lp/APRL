...
public class AprlInheritanceModifierImpl extends ASTWrapperPsiElement implements AprlInheritanceModifier {

  public AprlInheritanceModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AprlVisitor visitor) {
    visitor.visitInheritanceModifier(this);
  }
