...
public class AprlInitializerBodyImpl extends ASTWrapperPsiElement implements AprlInitializerBody {

  public AprlInitializerBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AprlVisitor visitor) {
    visitor.visitInitializerBody(this);
  }
