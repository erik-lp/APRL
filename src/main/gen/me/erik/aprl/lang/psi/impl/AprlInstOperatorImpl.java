...
public class AprlInstOperatorImpl extends ASTWrapperPsiElement implements AprlInstOperator {

  public AprlInstOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AprlVisitor visitor) {
    visitor.visitInstOperator(this);
  }
