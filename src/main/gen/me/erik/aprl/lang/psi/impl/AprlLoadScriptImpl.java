...
public class AprlLoadScriptImpl extends ASTWrapperPsiElement implements AprlLoadScript {

  public AprlLoadScriptImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AprlVisitor visitor) {
    visitor.visitLoadScript(this);
  }
