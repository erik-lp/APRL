...
public class AprlMemberAccessOperatorImpl extends ASTWrapperPsiElement implements AprlMemberAccessOperator {

  public AprlMemberAccessOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
