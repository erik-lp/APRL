...
public class AprlMultiplicativeOperatorImpl extends ASTWrapperPsiElement implements AprlMultiplicativeOperator {

  public AprlMultiplicativeOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
