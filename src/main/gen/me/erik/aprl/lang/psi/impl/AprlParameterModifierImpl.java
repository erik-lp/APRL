...
public class AprlParameterModifierImpl extends ASTWrapperPsiElement implements AprlParameterModifier {

  public AprlParameterModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
