...
public class AprlParenthesizedExpressionImpl extends ASTWrapperPsiElement implements AprlParenthesizedExpression {

  public AprlParenthesizedExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
