...
public class AprlParenthesizedTypeImpl extends ASTWrapperPsiElement implements AprlParenthesizedType {

  public AprlParenthesizedTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
