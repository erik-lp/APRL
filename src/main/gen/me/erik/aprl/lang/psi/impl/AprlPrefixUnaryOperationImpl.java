...
public class AprlPrefixUnaryOperationImpl extends ASTWrapperPsiElement implements AprlPrefixUnaryOperation {

  public AprlPrefixUnaryOperationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AprlVisitor visitor) {
    visitor.visitPrefixUnaryOperation(this);
  }
  ...
  @Override
  @Nullable
  public AprlLabelDefinition getLabelDefinition() {
    return findChildByClass(AprlLabelDefinition.class);
  }
