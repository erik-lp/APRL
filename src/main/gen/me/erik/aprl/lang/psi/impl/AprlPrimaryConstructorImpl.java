...
public class AprlPrimaryConstructorImpl extends ASTWrapperPsiElement implements AprlPrimaryConstructor {

  public AprlPrimaryConstructorImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public AprlClassParameters getClassParameters() {
    return findNotNullChildByClass(AprlClassParameters.class);
  }
