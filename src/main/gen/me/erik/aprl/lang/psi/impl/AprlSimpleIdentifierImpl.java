...
public class AprlSimpleIdentifierImpl extends ASTWrapperPsiElement implements AprlSimpleIdentifier {

  public AprlSimpleIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
