...
public class AprlStatementsImpl extends ASTWrapperPsiElement implements AprlStatements {

  public AprlStatementsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<AprlStatement> getStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AprlStatement.class);
  }
