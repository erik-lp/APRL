...
public class AprlStructDeclarationImpl extends ASTWrapperPsiElement implements AprlStructDeclaration {

  public AprlStructDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
