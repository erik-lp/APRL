...
public class AprlSuperExpressionImpl extends ASTWrapperPsiElement implements AprlSuperExpression {

  public AprlSuperExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public AprlLabelReference getLabelReference() {
    return findChildByClass(AprlLabelReference.class);
  }
