...
public class AprlTrileanLiteralImpl extends ASTWrapperPsiElement implements AprlTrileanLiteral {

  public AprlTrileanLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AprlVisitor visitor) {
    visitor.visitTrileanLiteral(this);
  }
