...
public class AprlVariableDeclarationImpl extends ASTWrapperPsiElement implements AprlVariableDeclaration {

  public AprlVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
