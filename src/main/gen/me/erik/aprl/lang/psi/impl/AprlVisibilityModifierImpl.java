...
public class AprlVisibilityModifierImpl extends ASTWrapperPsiElement implements AprlVisibilityModifier {

  public AprlVisibilityModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
