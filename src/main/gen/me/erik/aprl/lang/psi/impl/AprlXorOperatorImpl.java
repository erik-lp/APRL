...
public class AprlXorOperatorImpl extends ASTWrapperPsiElement implements AprlXorOperator {

  public AprlXorOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AprlVisitor visitor) {
    visitor.visitXorOperator(this);
  }
